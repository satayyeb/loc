...
public class test {
    ...
    public static void main(String[] args) {
        ...
        while(stop_flag=='F'){
            ...
            int_minterms = scan_minterms(int_minterms, s);
    ...
    public static int[] scan_minterms(int[] temp_array, Scanner scanner) {
...
//        int[] temp_array = new int[200];
        ...
        for (String s : scanner.nextLine().split(",")) {
            temp_array[i] = Integer.parseInt(s);
            i++;
        }
...
//        }
    ...
    public static void give_output(String[] output_array) {
        ...
        System.out.println(output_string.substring(2));
    }
